...
import com.erasmo.enums.Direcao;
...
import com.erasmo.structure.EntidadeSimulavel;
import com.erasmo.structure.PainelChamadas;
...
public class CentralDeControle extends EntidadeSimulavel implements Serializable {
    ...
    /**
     * Atualiza a matriz que controla quais elevadores estão designados para
     * cada andar/direção
     */
    ...
    /**
     * Verifica se já existe um elevador designado para atender um andar em uma
     * direção específica
     */
    ...
    /**
     * Registra que um elevador foi designado para atender um andar em uma
     * direção específica
     */
    ...
    /**
     * Implementação da heurística para minimizar tempo de espera Prioriza
     * andares com maior tempo de espera e pessoas esperando há mais tempo
     */
    ...
    /**
     * Implementação da heurística para minimizar consumo de energia Prioriza
     * deslocamentos mais curtos e evita movimentação desnecessária
     */
    ...
    /**
     * Escolhe o melhor elevador para atender uma chamada específica Método
    ...
    /**
     * Calcula uma pontuação que indica o quão adequado um elevador é para
     * atender uma chamada Método mantido para compatibilidade, mas não é mais
     * usado diretamente
     */
    ...
    /**
     * Verifica se uma pessoa pode embarcar no elevador com base no andar e na
     * direção
     */
